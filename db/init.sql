...
VALUES ('student_1', 'Иван', 'Иванов', 'ivanov@example.com',
       ...
       ('student_2', 'Мария', 'Петрова', 'petrova@example.com',
        ...
        'student_2', 'petrova',
        'DISABLED', 'STUDENT', 2),
       ('student_3', 'Елена', 'Козлова', 'kozlova@example.com',
        '$2a$04$Fx/SX9.BAvtPlMyIIqqFx.hLY2Xp8nnhpzvEEVINvVpwIPbA3v/.i',
        'student_3', 'kozlova',
        'ACTIVE', 'STUDENT', 1),
       ('student_4', 'Елена', 'Козлова', 'kozlova66@example.com',
        '$2a$04$Fx/SX9.BAvtPlMyIIqqFx.hLY2Xp8nnhpzvEEVINvVpwIPbA3v/.i',
        'student_4', 'kozlova2',
        'ACTIVE', 'STUDENT', 1),
       ('student_5', 'Елена', 'Козлова', 'kozlova2@example.com',
        '$2a$04$Fx/SX9.BAvtPlMyIIqqFx.hLY2Xp8nnhpzvEEVINvVpwIPbA3v/.i',
        'student_5', 'kozlova3',
        'ACTIVE', 'STUDENT', 1),
       ('student_6', 'Елена', 'Козлова', 'kozlova3@example.com',
        '$2a$04$Fx/SX9.BAvtPlMyIIqqFx.hLY2Xp8nnhpzvEEVINvVpwIPbA3v/.i',
        'student_6', 'kozlova4',
        'ACTIVE', 'STUDENT', 1),
